...
export class ConsignActionsCell implements ICellRendererAngularComp {
      ...
      .openDialog(DeleteEntityComponent, {
        ...
        data: {
          title: this.translateService.instant(
            AppTranslate.Consignments + '.delete-consignment-title'
          ),
          message: this.translateService.instant(
            AppTranslate.Consignments + '.delete-consignment-message'
          ),
        },
      })
      .subscribe((res) => {
        if (res) {
          this.consignmentService
            .deleteConsignment({ id: this.params.data.id })
            .subscribe((data) => {
